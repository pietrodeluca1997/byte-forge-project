...
void Pong::CreateWalls()
{
    ...
    ecsRegistry->AddComponent<Transform2DComponent>(rightWall, vec2(multimediaLayer->GetWindowWidth() - BASE_PROPORTION, 0), DEFAULT_SCALE, DEFAULT_ANGLE_ROTATION);
    ecsRegistry->AddComponent<SpriteComponent>(rightWall, vec2(BASE_PROPORTION, multimediaLayer->GetWindowHeight()));
}
